<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="title.font.family" select="'Arial'" xse:type="string" 
    xse:annotation="Specifies font for titles"/>
  <xsl:param name="dingbat.font.family" select="'Times'"/>
  <xsl:param name="sans.font.family" select="'Arial'" xse:type="string" 
  ...
  <xsl:param name="monospace.font.family" select="'Courier New'" xse:type="string" 
